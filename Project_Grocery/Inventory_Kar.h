...
// write in file
void write_to_file_k()
{
    fstream f;
    item_k i;
    f.open("store_kar.dat", ios::binary | ios::out | ios::app);
    i.getdata();
    f.write((char*)&i, sizeof(i));
    f.close();
    cout << "The Items has been created.." << endl;
}
void display_k() // this function reads all records from the file
{
    fstream f;
    item_k i;
    cout << "\t\tDisplay all Records.!\n"
        << endl;
    f.open("store_kar.dat", ios :: binary |ios::in);
...
void display_sp_k(int n) // function to read specific record from the file
{
    fstream f;
    item_k i;
    int flag = 0;
...
void modify_k()
{
    ...
    cin >> no;
    f.open("store_kar.dat", ios::binary | ios::in | ios::out);
...
void delete_rec_k()
{
    ...
    f.open("store_kar.dat", ios::binary | ios::in | ios::out);
    fstream f2;
    f2.open("temp_kar.dat", ios::binary | ios::out);
    f.seekg(0, ios::beg);
    while (f.read((char*)&i, sizeof(i)));
    {
        if (i.getItemnm() != no)
...
void menu_k()//function to display all products price list
{
    fstream f;
    item_k i;
    system("cls");
...
void place_order_k()//function to place order and generate bill
{
    fstream f;
    item_k i;
    system("clr");
